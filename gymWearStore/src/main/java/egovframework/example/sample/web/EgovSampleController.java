...
public class EgovSampleController {
	...
	@RequestMapping(value = "/find-account.do")
	public String find_account() {
		System.out.println("find-account.do");
		return "sample/find-account.html";
	}

	@RequestMapping(value = "/product.do")
	public String product() {
		System.out.println("product.do");
		return "sample/product.html";
	}

	@RequestMapping(value = "/products-list.do")
	public String products_list() {
		System.out.println("products-list.do");
		return "sample/products-list.html";
	}

	@RequestMapping(value = "/faq.do")
	public String faq() {
		System.out.println("faq.do");
		return "sample/faq.html";
	}

	@RequestMapping(value = "/dum-data.do")
	public String dum_data() {
		System.out.println("dum-data.do");
		return "sample/dum-data.html";
	}
